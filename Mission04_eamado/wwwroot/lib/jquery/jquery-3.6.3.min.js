...
$('#calcButton').click(function () {
    ...
    if (AssignmentsV < 0 || AssignmentsV > 100) {
        $('#errorMessage').text("The value of Assignments must be between 0 and 100.");
        return false;
    }
    if (GroupProjectsV < 0 || GroupProjectsV > 100) {
        $('#errorMessage').text("The value of Group Projects must be between 0 and 100.");
        return false;
    }
    if (MidtermExamsV < 0 || MidtermExamsV > 100) {
        $('#errorMessage').text("The value of Midterm Exams must be between 0 and 100.");
        return false;
    }
    if (FinalExamsV < 0 || FinalExamsV > 100) {
        $('#errorMessage').text("The value of Final Exams must be between 0 and 100.");
        return false;
    }
    if (QuizzesV < 0 || QuizzesV > 100) {
        $('#errorMessage').text("The value of Participation must be between 0 and 100.");
        return false;
    }
    if (IntexV < 0 || IntexV > 100) {
        $('#errorMessage').text("The value of Attendance must be between 0 and 100.");
        return false;
    }
